...
import ListManagerFeatureWhyUs from "./ListManager_fiature_why_us";
...
const WyeUsSection = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (
    // data.why_us_title.trim() !== '' 
		// && data.why_us_details.trim() !== ''
		// && data.why_us_title_ar.trim() !== ''
		// && data.why_us_details_ar.trim() !== ''
