...
export const StartOrEndStepOrSubStepProcess = ({resort_for='step', disabled_status=false, action='start_process', projectflow_id=null,   step_id=null, sub_step_id=null, reloadComponentMethod}) =>{
    ...
    return(
        ...
        <button type="button" disabled={!disabled_status || isSubmitting} onClick={handleSubmit}  className="btn btn-outline-primary btn-sm small m-2 "> {action === 'start_process' ? "Start Process" : "End Process" } </button>
